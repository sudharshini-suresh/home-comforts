 ...
 <div class="account-main">
    ...
    <div class="menubar ">
        ...
        <nav class="navbar">
          ...
          <hr>
                <a class="navitem" href="User_ReLoginServlet">
                ...
                <a class="navitem" href="LogoutServlet">
        ...
        <div class="layer1">   
            <div class="part-2">
                <div class="form-content">
                    ...
                    <form id=SignUp  action="UrlReWrite1">
                        
                            <input type="text" class="input-form" id="fullname" placeholder="Username" name="uname"> 
                    ...
                    <form id=LoginForm name="myform" action="User_LoginServlet" method="post">
