 ...
 <div class="main">
    ...
    <div class="menubar ">
        ...
        <nav class="navbar">
            <div class="navcontent">
                ...
                <a class="navitem" href="#about-us">
                    <i class="fa fa-info-circle"></i>
                    About Us
                </a>
                <a class="navitem" href="collections.jspl#service">
    ...
    <div class="nav_tag">            
        <nav>
                ...
                <li class="menusection" ><a href="collections.jspl#corner-sofa">Corner Sofas</a></li>
                <li class="menusection"><a href="#">BEDS</a></li>
                <li class="menusection"><a href="collections.jsp#chairs">CHAIRS</a></li>
                <li class="menusection"><a href="collections.jspl#cushions">CUSHIONS</a></li>   
    ...
    <div class="content">
        <div class="layer1">
            <div class="part-2">
                ...
                <a href="profile.html#contact-us" class="btn">Get in Touch</a>
            </div>    
            <div class="part-2">
